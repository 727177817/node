...
exports.postOrder = async(ctx, next) => {
    ...
    let result = await order(userId, warehouseId, consigneeId, couponId, couponSn, shippingType, shippingDate, postscript);
...
async function order(userId, warehouseId, consigneeId, couponId, couponSn, shippingType, shippingTime, postscript) {
